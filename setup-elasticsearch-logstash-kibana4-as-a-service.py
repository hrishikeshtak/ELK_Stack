...
subprocess.call("sed -ie 's/#cluster.name: elasticsearch/cluster.name: elasticsearch/' /etc/elasticsearch/elasticsearch.yml",shell=True);
string = "sed -ie 's/#network.host: 192.168.0.1/network.host: " + IP_ADDRESS+"/' /etc/elasticsearch/elasticsearch.yml"
...
subprocess.call("tar -xvf ~/kibana-4.0.1-linux-x64.tar.gz",shell=True);
